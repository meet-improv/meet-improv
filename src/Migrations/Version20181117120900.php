 ...
 */
final class Version20181117120900 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contributor (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', created_by_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', troupe_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', name VARCHAR(100) NOT NULL, description VARCHAR(255) NOT NULL, short_name VARCHAR(70) NOT NULL, identifier VARCHAR(100) NOT NULL, location VARCHAR(100) NOT NULL, banner_pic_url VARCHAR(255) DEFAULT NULL, profile_pic_url VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, type VARCHAR(3) NOT NULL, UNIQUE INDEX UNIQ_DA6F9793772E836A (identifier), INDEX IDX_DA6F9793B03A8386 (created_by_id), INDEX IDX_DA6F9793EF084B38 (troupe_id), INDEX type_idx (type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE open_date (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', owner_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', created_by_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', start DATETIME NOT NULL, end DATETIME DEFAULT NULL, is_public TINYINT(1) NOT NULL, is_closed TINYINT(1) NOT NULL, name VARCHAR(100) NOT NULL, description VARCHAR(255) DEFAULT NULL, identifier VARCHAR(160) NOT NULL, INDEX IDX_136A765F7E3C61F9 (owner_id), INDEX IDX_136A765FB03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE open_dates_invitations (open_date_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', contributor_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', INDEX IDX_956A00F0D5A3FA98 (open_date_id), INDEX IDX_956A00F07A19A357 (contributor_id), PRIMARY KEY(open_date_id, contributor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
